    ...
    <body>
        ...
        <div class="home">
            <div class="image-container">
                <img class="kihumuro" src="images/IMG-20211229-WA0023.webp" alt="Kihumuro Boys Hall" title="Kihumuro Boys Hall">
            </div>
            <div class="text-container">
                <h2>Tank Hill</h2>
                <p>Comfortable and affordable accomodation provided only to the gents</p>
                <a href="tankhill.php" class="button2">TANK HILL</a>
            </div>
        </div>
        ...
        <div class="home">
            ...
            <div class="text-container">
                ...
                <a href="corpuschristi.php" class="button2">CORPUS CRISTI</a>
            </div>
        </div>
        <footer>
            <div class="end">
